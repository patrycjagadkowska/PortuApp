...
const Test = () => {
  ...
  const unitNum =
    unitId.charAt(1) === "0" ? unitId.substring(2) : unitId.substring(1);
      ...
      {!quizStarted && (
        <>
          <p className={classes["test__rules"]}>
            You will have to answer to 10 questions. For each question you have
            4 possible answers. To answer for each question you have 10 seconds.
            To pass this test you have to answer correctly to at least 8 of
            them. Good luck!
          </p>
