...
const UserData = () => {
    ...
    const userPhoto = auth.currentUser.photoURL ? auth.currentUser.photoURL : blankProfilePicutre;
    ...
    return (
      <section className={classes.userData}>
        ...
        <div className={classes["userData__data"]}>
          <p>
            Name: <span className={classes["userData__data--info"]}>{auth.currentUser.displayName}</span>
          </p>
          <p>
            Email:{" "}
